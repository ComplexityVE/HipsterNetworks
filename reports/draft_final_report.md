...
*FIGURE 2 - LEFT: τ = 1. A graph of steady state adoption fractions of the model with τ equal to 1 and a sweep of P hipster values. For each value of P, we ran 100 simulations with time step 20 and averaged the adoption fractions at a steady state. RIGHT: Juul and Porter graph of the steady state adoption fractions of their model with τ = 1.*
